...
export default function GalleryComponent({ propertyItem }) {
    ...
    <>
      <Gallery>
        <section className="flat-gallery-single">
          <Item
            original="/images/banner/BR Mila - Scene 02.0.jpg"
            thumbnail="/images/banner/BR Mila - Scene 02.0.jpg"
            width={960}
            height={680}
          >
            {({ ref, open }) => (
              <div className="item1 box-img">
                <a onClick={open} className="d-block" data-fancybox="gallery">
                  <img
                    alt="img-gallery"
                    ref={ref}
                    src="/images/banner/BR Mila - Scene 02.0.jpg"
                    width={960}
                    height={680}
                  />
                </a>
          ...
          {propertyItem.gallery.map((item, index) => (
            <Item
              original={item.src}
              thumbnail={item.src}
              width={660}
